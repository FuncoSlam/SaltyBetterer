...
class InputParser
{
    ...
    public InputParser(Program program)
    {
        ...
        commands = new Command[] {
            ...
            new Command("bet", new Action<string>(BetCommand), "Changes the bet amount permanently, takes an integer"),
            new Command("help", new Action(HelpCommand), "Displays all commands with descriptions, this is probably that one"),
            new Command("bookmark", new Action<string>(BookmarkCommand), "Creates a bookmark of current salt, can take a string"),
